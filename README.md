## ArrayList for Arduino
Dynamic array (similiar to vector) library for Arduino.

## Example
The API is pretty straight forward. Below example provide full functionality of this library.
```c++
#include "ArrayList.h"
